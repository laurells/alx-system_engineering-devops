0-hello_world file script prints the word 'Hello, World" followed by a new line to the standard output.
...
22-users_and_homes file script displays all users and their home directories sorted by users.
